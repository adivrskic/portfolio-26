...
export const MENU_PROJECTS = [
  ...
  {
    title: "Ascend",
    desc: "Chrome start page integrating real-time APIs for news, weather, location, and traffic information",
    tech: "JavaScript · REST APIs",
    year: "2023",
  },
  {
    title: "README Generator",
    desc: "AI-powered tool that scans GitHub repos and generates customizable README documentation from codebase content",
    tech: "Node.js · AI · GitHub API",
    year: "2023",
  },
];
